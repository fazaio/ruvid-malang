  ...
  <div>
    ...
    <div class="container mx-auto">
      <div class="text-center">
        ...
        <div class="text-sm">Jl. Buring No.10, Oro-oro Dowo, Kec. Klojen, Kota Malang, Jawa Timur 65119</div>
        <div class="text-sm">+62341325443</div>
      </div>
      <div class="block md:grid lg:grid xl:grid grid-cols-2 gap-6">
        <template v-for="row in loopGolongan" :key="row.no" >
      ...
      <div class="mt-3 px-4 py-2 mx-4 bg-white">
        ...
        <div>
          Data Diatas Dapat <b>Berubah</b> sewaktu-waktu, cek pada halaman resmi untuk informasi lebih lanjut. <br>
          <b>Sumber Data:</b> http://ayodonor.pmi.or.id/stokdarah.php?module=3573
        </div>
      </div>
    </div>
  </div>
